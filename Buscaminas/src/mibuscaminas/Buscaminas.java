...
principiante nivelPrincipiante = new principiante();
	...
	demente nivelDemente = new demente();
        padrenuestro nivelsupremo=new padrenuestro();
        private boolean prin=true, inter=false, demen=false, nuestro=false;  
    ...
    private void initComponents() {
        ...
        itemdios = new javax.swing.JMenuItem();
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENESPRESENTACIOM/10.jpg"))); // NOI18N
        jLabel4.setText(bundle.getString("Buscaminas.jLabel4.text")); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENESPRESENTACIOM/11.jpg"))); // NOI18N
        jLabel5.setText(bundle.getString("Buscaminas.jLabel5.text")); // NOI18N
        ...
        translucidoLayout.setVerticalGroup(
            ...
            .addGroup(translucidoLayout.createSequentialGroup()
                ...
                .addGroup(translucidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addComponent(jLabel2))
                .addGroup(translucidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(translucidoLayout.createSequentialGroup()
                        .addGap(63, 63, 63)
                        .addGroup(translucidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                            .addComponent(jLabel5)))
                    .addGroup(translucidoLayout.createSequentialGroup()
                        .addGap(34, 34, 34)
        ...
        itemdios.setText(bundle.getString("Buscaminas.itemdios.text")); // NOI18N
        itemdios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itemdiosActionPerformed(evt);
            }
        });
        jMenu1.add(itemdios);

        jMenuItem1.setText(bundle.getString("Buscaminas.jMenuItem1.text")); // NOI18N
...
translucido.setVisible(false);
    ...
    private void itemdiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemdiosActionPerformed
translucido.setVisible(false);
        nivelDemente.botonD.setIcon(ima[2]);
            ...
            setLocationRelativeTo(null);      
        	        ...
        	        // TODO add your handling code here:
    }//GEN-LAST:event_itemdiosActionPerformed
...
translucido.setVisible(false);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        translucido.setVisible(false);
     JOptionPane.showMessageDialog(null, "este nivel es el mas facil\n ya que contiene la ayuda \nde dios ");
        nivelsupremo.botons.setIcon(ima[2]);
        	nivelsupremo.quitarBotonespadre();
        	nivelsupremo.setVisible(false);            
        	nivelsupremo.labels.setText("");
        	nivelsupremo.nuevaPartidapadre();
        	nivelsupremo.setVisible(true);
        	if(prin){
        		this.remove(nivelPrincipiante);
        		this.add(nivelsupremo);
        		prin=false;
        		nuestro=true; 
        	}else if(demen){
        		this.remove(nivelDemente);
...
translucido.setVisible(false);
    ...
    private javax.swing.JMenuItem itemdios;
